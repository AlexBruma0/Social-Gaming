...
class TreeNode {
    public:
        ...
        void addChild(std::unique_ptr<TreeNode> child) const; //change
...
class TreeNodeImpl { 
    ...
    public:
        ...
        void addChild(std::unique_ptr<TreeNode> child); //change
    ...
    protected:
        ...
        std::vector<std::unique_ptr<TreeNode>> children; //change
};
