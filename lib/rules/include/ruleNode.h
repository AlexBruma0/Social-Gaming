...
// (cstong) Wrapper class so that we can iterate over all tree nodes
// Could not iterate over Treenode<T> since T might be different
// Could try and use variants later, but will become long
class TreeNode {
    public:
